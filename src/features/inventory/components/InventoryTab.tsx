                  ...
                  >
                    ...
                    <div className="p-4 pt-0 flex items-center justify-between" onClick={(e) => e.stopPropagation()}>
                      ...
                      <div className="flex items-center gap-1">
                        <button
                          onClick={() => onUpdateStock(item.id, Math.max(0, item.stockQty - 1))}
                          className="p-1 rounded-lg bg-amber-100 text-amber-800 hover:bg-amber-200 cursor-pointer"
                        >
                      ...
                      >
                        ...
                        <td className="py-4 px-6 text-center" onClick={(e) => e.stopPropagation()}>
                          <div className="flex items-center justify-center gap-2">
                            <button
                              onClick={() => onUpdateStock(item.id, Math.max(0, item.stockQty - 1))}
                              className="p-1 rounded-lg bg-white border border-slate-200 text-slate-500 hover:bg-slate-100 cursor-pointer"
                            >
                              <Minus className="w-3.5 h-3.5" />
                            </button>
                            <span className="font-bold text-slate-900 w-12 text-center">{item.stockQty}</span>
                            <button
                              onClick={() => onUpdateStock(item.id, item.stockQty + 1)}
                              className="p-1 rounded-lg bg-white border border-slate-200 text-slate-500 hover:bg-slate-100 cursor-pointer"
                            >
